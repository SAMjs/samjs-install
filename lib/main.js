(function() {
  var connections, fs, kwm, path, webpack, webpackConfig;
  ...
  module.exports = function(options) {
    return function(samjs) {
      ...
      samjs.addHook("beforeStartup", function() {
        var compiler, configItems, i, icon, icons, installItems, j, k, key, koa, l, len, len1, len2, len3, m, ref, ref1, ref2, ref3, ref4, ref5, val, wdm;
